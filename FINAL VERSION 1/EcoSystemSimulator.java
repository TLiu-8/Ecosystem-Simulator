...
class EcoSystemSimulator {
  ...
  EcoSystemSimulator(int wolfNum, int wolfHealth, int sheepNum, int sheepHealth, int plantHealth, int plantNum, double plantGrowth, int side){
  ...
  public void simulate(){
    ...
    for(int i = 0; i < sheepNum; i++){
      ...
      objSheep.setAge(20);
      objSheep.setSize(objSheep.getSize() + 40);
      map[x][y] = objSheep;
    }
    ...
    for (int i = 0; i < wolfNum; i++){
      ...
      objWolf.setAge(20);
      objWolf.setSize(objWolf.getSize() + 40);
      map[x][y] = objWolf;
    }
